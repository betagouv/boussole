...
class Working < ApplicationRecord
  ...
  class ServiceOfferings < Trailblazer::Operation
    ...
    # @!attribute [r] working
    #
    # @return [Working] The {Working} project we're matching against.
    #
    attr_reader :working
    ...
    #
    # Search for {ServiceOffering}s matching the current working project with a set of
    # predefined rules.
    #
    ...
    # @example
    #
    #   Working::ServiceOfferings.present(1)
    ...
    #
    # @param [Array] conditions The conditions to check against the {Working}.
    #
    # @example
    #
    #   working.experience
    #   #=> true
    #
    #   conditions = [{ "attribute" => "experience", "operator" => "==", "value" => true }]
